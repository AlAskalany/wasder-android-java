...
public class AppInjector {
    ...
    public static void init(WasderApplication wasderApplication) {
        /*DaggerAppComponent.builder()
        .application(wasderApplication)
        .build()
        .inject(wasderApplication);*/

        wasderApplication.registerActivityLifecycleCallbacks(
