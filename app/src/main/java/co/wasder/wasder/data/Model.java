...
public class Model {
    ...
    public static FeedModel FirestoreItem(
        ...
        return new FeedModel(uId, "NAME", profilePhotoUrl, photo, numRatings, avgRating, feedText);
    }
    ...
    public static Rating Rating(
            ...
            @SuppressWarnings("SameParameterValue") final double rating,
            @SuppressWarnings("SameParameterValue") final String text) {
        Model.rating = rating;
        Model.text = text;
    ...
    public static Event Event(
        ...
        // TODO remove name parameter
        return new Event(
                uId, "NAME", title, profilePhotoUrl, photo, numRatings, avgRating, feedText);
    }
}
