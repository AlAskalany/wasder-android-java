...
import co.wasder.wasder.ui.fragment.tab.live.DiscoveryTabFragment;
import co.wasder.wasder.ui.fragment.tab.live.FavoritesTabFragment;
import co.wasder.wasder.ui.fragment.tab.live.FollowingTabFragment;
...
public class LiveNavigationFragment extends Fragment implements NavigationFragment,
    ...
    public static LiveNavigationFragment newInstance(int sectionNumber) {
    ...
    public LiveNavigationFragment addTab(TabFragment tab) {
        fragments.add(tab);
        return this;
    }
