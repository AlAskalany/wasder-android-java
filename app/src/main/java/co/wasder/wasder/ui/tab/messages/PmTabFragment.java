package co.wasder.wasder.ui.tab.messages;
...
public class PmTabFragment extends Fragment implements TabFragment, LifecycleOwner {
    ...
    @NonNull
    public static PmTabFragment newInstance(final int sectionNumber) {
        final PmTabFragment fragment = new PmTabFragment();
    ...
    public void initRecyclerView() {
        ...
        final RecyclerView.Adapter<FeedViewHolder> adapter = RecyclerAdapterFactory
                .getFeedRecyclerAdapter(this, mItemSelectedListener, mQuery, FeedModel.class);
