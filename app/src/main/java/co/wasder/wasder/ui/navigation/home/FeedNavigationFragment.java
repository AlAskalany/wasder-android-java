package co.wasder.wasder.ui.navigation.home;
...
import co.wasder.wasder.ui.navigation.home.tabs.feed.FeedTabFragment;
...
public class FeedNavigationFragment extends Fragment implements NavigationFragment,
    ...
    public static void showSearchBar(@NonNull WasderActivity activity) {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            final FeedTabFragment feedTab = FeedTabFragment.newInstance(0,
                    "Feed");
            this.addTab(feedTab);
