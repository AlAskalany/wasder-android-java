 ...
 */
@Keep
public class FollowingTabFragment extends Fragment implements TabFragment, LifecycleOwner {
    ...
    @NonNull
    public static FollowingTabFragment newInstance(final int sectionNumber) {
        final FollowingTabFragment fragment = new FollowingTabFragment();
        final Bundle args = new Bundle();
        args.putInt(ARG_SECTION_NUMBER, sectionNumber);
        fragment.mTitle = "Following";
