package co.wasder.wasder.ui.navigation.messages;
...
import co.wasder.wasder.ui.navigation.messages.tabs.mentions.MentionsTabFragment;
import co.wasder.wasder.ui.navigation.messages.tabs.pm.PmTabFragment;
...
public class MessagesNavigationFragment extends Fragment implements NavigationFragment,
    ...
    @NonNull
    public MessagesNavigationFragment addTab(final BaseTabFragment tab) {
        fragments.add(tab);
        return this;
    }
